...
@section('content')
<div class="px-5">
<div id="Success" class="relative flex flex-col px-5 ">
                        ...
                        <div class="flex flex-col gap-4 mt-[10px]">
                            <div
                                ...
                                <div class="w-[128px] h-[88px]">
                                    <img src="{{ asset('storage/' . $transactionDetail->product->image) }}" class="w-full object-cover rounded-[8px]"
                                        alt="icon">
                                </div>
                                <div class="flex flex-col gap-1 w-full">
                                    ...
                                    <div class="flex items-center justify-between ">
                                        <p class="text-[#FF001A] font-[600] text-[14px]">
                                            Rp {{ number_format($transactionDetail->product->price) }}
                                        </p>
                                    </div>
                                </div>
