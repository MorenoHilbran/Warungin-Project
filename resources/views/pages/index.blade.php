...
@section('content')
<div id="Background" class="absolute top-0 w-full h-[170px] rounded-b-[45px] bg-[linear-gradient(90deg,#FF923C_0%,#FF801A_100%)]">
        </div>
        ...
        <div id="Recomendations" class="relative flex flex-col px-5 mt-[20px]">
            <div class="flex items-end justify-between ">
                <h1 class="text-[#353535] font-[500] text-lg">Products Recommendations</h1>
                <a href="#" class="text-[#FF801A] text-sm ">See All</a>
            </div>
